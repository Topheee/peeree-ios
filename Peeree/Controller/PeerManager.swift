...
extension CBUUID {
    ...
    static let PeereeCharacteristicIDs = [RemoteUUIDCharacteristicID, LocalUUIDCharacteristicID, PortraitCharacteristicID, PinnedCharacteristicID, AggregateCharacteristicID, LastChangedCharacteristicID, NicknameCharacteristicID]
