...
public protocol AccountViewModelDelegate: AnyObject, Sendable {
	...
	/// The recovery code generated by the server.
	var recoveryCodeLetters: [String] { get set }

	/// Whether the recovery code should be presented.
	var presentRecoveryCode: Bool { get set }
}
